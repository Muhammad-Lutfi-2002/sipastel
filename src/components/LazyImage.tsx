...
export const LazyImage: React.FC<LazyImageProps> = ({
  ...
  return (
    <div
      className={`relative w-full overflow-hidden bg-[#EFECE4] ${aspectRatio}`}
      onClick={onClick}
    >
      ...
      {/* Fallback if broken */}
      {hasError && (
        <div className="absolute inset-0 flex items-center justify-center bg-[#EAE6DD] text-[#75726B] text-xs p-2 text-center">
