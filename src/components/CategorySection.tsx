      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
        {categoriesData.map((cat) => (
          <div
            ...
            className="group relative aspect-[3/4] overflow-hidden rounded-[2px] bg-[#EFECE4] border border-[#E5E1D7] cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#1C1B1A] focus-visible:ring-offset-2"
          >
            {/* Background Image */}
            <img
              src={cat.image}
            ...
            {/* Content overlay */}
            <div className="absolute inset-0 p-4 sm:p-5 md:p-6 flex flex-col justify-between text-[#FAF9F5]">
              <div className="flex justify-end">
                <span className="w-8 h-8 rounded-full bg-[#FAF9F5]/20 backdrop-blur-xs flex items-center justify-center text-[#FAF9F5] group-hover:bg-[#FAF9F5] group-hover:text-[#1C1B1A] transition-all">
              ...
              <div>
                ...
                <h3 className="font-heading text-lg sm:text-xl md:text-2xl font-extrabold tracking-tight text-[#FAF9F5] uppercase">
                  {cat.name}
                </h3>
