          ...
          >
            {logoUrl ? (
              ...
              <span className="flex flex-col">
                ...
                <span className="text-[9px] uppercase tracking-[0.25em] text-body font-semibold -mt-0.5">
                  SIPASTEL OFFICIAL
                </span>
              </span>
            )}
            ...
            >
              ...
              {cartCount > 0 && (
                <span
                  ...
                  className={`absolute top-1 right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-accent text-ink-soft text-[10px] font-bold flex items-center justify-center leading-none transition-transform ${
                ...
                <div>
                  {logoUrl ? (
                    ...
                    <>
                      ...
                      <span className="text-[9px] uppercase tracking-[0.2em] text-body">
                        APPAREL STUDIO
                      </span>
                    </>
                  )}
