...
export const OrdersView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="p-3.5 bg-white border border-[#EAE6DF] rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-3 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
        {/* Search */}
