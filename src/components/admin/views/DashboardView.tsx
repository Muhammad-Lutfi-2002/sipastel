    ...
    <div className="space-y-7 animate-fade-in">
      ...
      {isLoading ? (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {[1, 2, 3, 4].map((n) => (
            <div key={n} className="p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-2xl space-y-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {/* Total Orders */}
          <div className="p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-2xl flex flex-col justify-between transition-all hover:-translate-y-0.5 hover:border-[#D87A61]/40 hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
          ...
          {/* Pending Payment */}
          <div className="p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-2xl flex flex-col justify-between transition-all hover:-translate-y-0.5 hover:border-[#C27828]/40 hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#8C8880]">
                MENUNGGU PEMBAYARAN
              </span>
          ...
          {/* In Production */}
          <div className="p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-2xl flex flex-col justify-between transition-all hover:-translate-y-0.5 hover:border-[#7B5EA7]/40 hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#8C8880]">
                SEDANG PRODUKSI
              </span>
          ...
          {/* Ready to Ship */}
          <div className="p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-2xl flex flex-col justify-between transition-all hover:-translate-y-0.5 hover:border-[#4A7C59]/40 hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#8C8880]">
                SIAP KIRIM
              </span>
      ...
      <div className="p-4 sm:p-6 bg-white border border-[#EAE6DF] rounded-2xl space-y-5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 min-w-0 p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-2xl space-y-4 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#F0ECE5] pb-3">
            <div>
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#8C8880]">
                Volume &amp; Tren
        ...
        <div className="lg:col-span-4 min-w-0 p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-2xl space-y-3.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
