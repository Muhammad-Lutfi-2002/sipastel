  ...
  return (
    <div className="space-y-7 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-[#E8E5DF]">
        <div>
          <h2 className="font-heading text-xl sm:text-2xl font-bold tracking-tight text-[#1C1B1A] flex items-center gap-2">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2 pt-1 pb-1">
        ...
        <div className="flex items-center flex-wrap gap-2">
          <button
            ...
            className="px-3 py-1.5 bg-white hover:bg-[#FAF0EC] border border-[#E8E5DF] hover:border-[#D87A61]/60 text-xs font-medium text-[#1C1B1A] rounded-lg flex items-center gap-1.5 transition-colors cursor-pointer"
          >
      ...
      {isLoading ? (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {[1, 2, 3, 4].map((n) => (
            <div key={n} className="p-4 sm:p-5 bg-white border border-[#E8E5DF] rounded-2xl space-y-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {/* Total Orders */}
          <div className="p-4 sm:p-5 bg-white border border-[#E8E5DF] rounded-2xl flex flex-col justify-between transition-all hover:-translate-y-0.5 hover:border-[#D87A61]/40 hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#8C8880]">
                TOTAL PESANAN
              </span>
              <div className="w-7 h-7 rounded-lg bg-[#FAF0EC] flex items-center justify-center shrink-0">
                <ShoppingBag className="w-3.5 h-3.5 text-[#C14E30]" />
              </div>
            </div>
            <div className="my-2">
              <span className="font-heading text-2xl sm:text-3xl font-bold text-[#1C1B1A] tracking-tight">
                {totalOrders}
              </span>
            </div>
          ...
          {/* Pending Payment */}
          <div className="p-4 sm:p-5 bg-white border border-[#E8E5DF] rounded-2xl flex flex-col justify-between transition-all hover:-translate-y-0.5 hover:border-[#C27828]/40 hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#8C8880]">
                MENUNGGU PEMBAYARAN
              </span>
              <div className="w-7 h-7 rounded-lg bg-[#FBF1E3] flex items-center justify-center shrink-0">
                <Clock className="w-3.5 h-3.5 text-[#C27828]" />
              </div>
            </div>
            <div className="my-2">
              <span className="font-heading text-2xl sm:text-3xl font-bold text-[#1C1B1A] tracking-tight">
          ...
          {/* In Production */}
          <div className="p-4 sm:p-5 bg-white border border-[#E8E5DF] rounded-2xl flex flex-col justify-between transition-all hover:-translate-y-0.5 hover:border-[#7B5EA7]/40 hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#8C8880]">
                SEDANG PRODUKSI
              </span>
              <div className="w-7 h-7 rounded-lg bg-[#F1ECF8] flex items-center justify-center shrink-0">
                <Scissors className="w-3.5 h-3.5 text-[#7B5EA7]" />
              </div>
            </div>
            <div className="my-2">
              <span className="font-heading text-2xl sm:text-3xl font-bold text-[#1C1B1A] tracking-tight">
          ...
          {/* Ready to Ship */}
          <div className="p-4 sm:p-5 bg-white border border-[#E8E5DF] rounded-2xl flex flex-col justify-between transition-all hover:-translate-y-0.5 hover:border-[#4A7C59]/40 hover:-translate-y-0.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#8C8880]">
                SIAP KIRIM
              </span>
              <div className="w-7 h-7 rounded-lg bg-[#EFF6EF] flex items-center justify-center shrink-0">
                <Truck className="w-3.5 h-3.5 text-[#4A7C59]" />
              </div>
            </div>
            <div className="my-2">
              <span className="font-heading text-2xl sm:text-3xl font-bold text-[#1C1B1A] tracking-tight">
      ...
      <div className="p-4 sm:p-6 bg-white border border-[#E8E5DF] rounded-2xl space-y-5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#F0ECE5] pb-3">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-mono font-bold text-[#1C1B1A] px-2 py-0.5 rounded bg-[#F4F1EA]">
                {activeTimelineOrder?.orderId || 'Belum ada pesanan'}
              </span>
            </div>
            <p className="text-xs text-[#5E5B54] mt-0.5">
              Customer: <span className="font-semibold text-[#1C1B1A]">{activeTimelineOrder?.customer}</span> •{' '}
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-xs font-medium text-[#5E5B54] hover:text-[#1C1B1A] flex items-center gap-1 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
            >
        ...
        <div className="hidden md:flex items-center justify-between relative px-2 pt-2">
          ...
          <div className="absolute left-8 right-8 top-6 h-0.5 bg-[#E8E5DF] -z-0" />
          ...
          {productionStages.map((st, idx) => {
            ...
            return (
              <div key={st.key} className="flex flex-col items-center relative z-10 text-center">
                ...
                {/* Label & Status */}
                <span className="text-xs font-semibold text-[#1C1B1A] mt-2 block">
                  {st.label}
                </span>
                <span
            ...
            return (
              <div key={st.key} className="flex items-center gap-3">
                ...
                <div className="flex-1 flex items-center justify-between text-xs">
                  <span className="font-semibold text-[#1C1B1A]">{st.label}</span>
                  <span
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 min-w-0 p-4 sm:p-5 bg-white border border-[#E8E5DF] rounded-2xl space-y-4 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#F0ECE5] pb-3">
            <div>
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#8C8880]">
                Volume &amp; Tren
              </span>
              <h3 className="font-heading text-sm sm:text-base font-bold text-[#1C1B1A]">
                Performa Mingguan
              </h3>
            </div>
          ...
          <div className="relative pt-2 overflow-hidden rounded-lg">
            ...
            >
              ...
              <line x1="20" y1="140" x2="560" y2="140" stroke="#E8E5DF" />
              ...
              {points.map((pt, idx) => (
                <g key={pt.day} className="cursor-pointer">
                  <circle
                    ...
                    fill={activeHoverPoint === idx ? '#1C1B1A' : '#D87A61'}
                    stroke="#FFFFFF"
                    strokeWidth="2"
            ...
            {activeHoverPoint !== null && chartData[activeHoverPoint] && (
              <div
                className="absolute top-2 left-1/2 -translate-x-1/2 px-3 py-1.5 bg-[#1C1B1A] text-white text-xs rounded-md shadow-lg pointer-events-none flex items-center gap-2"
              >
        ...
        <div className="lg:col-span-4 min-w-0 p-4 sm:p-5 bg-white border border-[#E8E5DF] rounded-2xl space-y-3.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
          ...
          <div className="space-y-3 overflow-y-auto max-h-56 divide-y divide-[#F6F3EE]">
            {activityFeed.map((act) => (
              <div
                ...
                className="pt-2.5 first:pt-0 hover:bg-[#FAF6F2] p-1.5 rounded-lg transition-colors cursor-pointer text-xs focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#1C1B1A]"
              >
                <p className="text-[#1C1B1A] leading-snug font-medium">{act.text}</p>
                <div className="flex items-center flex-wrap gap-x-2 gap-y-0.5 justify-between mt-1 text-[10px] text-[#8C8880] font-mono">
                  <span>{act.time}</span>
                  <span className="text-[#C14E30] hover:underline font-semibold truncate max-w-full">
                    {act.orderId} →
                  </span>
                </div>
              </div>
      ...
      <div className="p-4 sm:p-6 bg-white border border-[#E8E5DF] rounded-2xl space-y-4 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
        ...
        <div className="overflow-x-auto -mx-4 sm:mx-0">
          <table className="w-full text-left text-xs border-collapse">
            <thead>
              <tr className="border-b border-[#E8E5DF] text-[#8C8880] font-mono text-[11px] uppercase tracking-wider">
            ...
            <tbody className="divide-y divide-[#F2EFE9]">
              {orders.slice(0, 6).map((order) => (
                ...
                >
                  {/* Order ID */}
                  <td className="py-3 px-3 font-mono font-semibold text-[#1C1B1A]">
                    {order.orderId}
                  </td>

                  {/* Customer */}
                  <td className="py-3 px-3">
                    <p className="font-semibold text-[#1C1B1A] leading-none">{order.customer}</p>
                  ...
                  <td className="py-3 px-3 max-w-xs">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[#1C1B1A] truncate font-medium">
                  ...
                  <td className="py-3 px-3 text-right">
                    <button
                      ...
                      className="opacity-70 group-hover:opacity-100 px-2.5 py-1 bg-white hover:bg-[#FAF0EC] border border-[#E8E5DF] hover:border-[#D87A61] text-[#1C1B1A] hover:text-[#C14E30] rounded-md font-medium text-xs transition-all cursor-pointer shadow-2xs"
                    >
                      Detail
                    </button>
                  </td>
