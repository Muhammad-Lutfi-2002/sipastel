  ...
  return (
    <div className="space-y-7 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-2xl space-y-4 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#F0ECE5] pb-3">
            <div>
              <span className="text-[11px] font-mono uppercase tracking-wider text-[#8C8880]">
                Volume &amp; Tren
        ...
        <div className="lg:col-span-4 p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-2xl space-y-3.5 shadow-[0_4px_20px_rgba(28,27,26,0.06)]">
