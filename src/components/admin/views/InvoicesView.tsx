              ...
              {filteredInvoices.length === 0 ? (
                <tr>
                  <td colSpan={8} className="py-14 text-center">
                    ...
                    <p className="text-xs font-semibold text-[#1C1B1A]">Tidak ada invoice ditemukan.</p>
                ...
                filteredInvoices.map((inv, idx) => (
                  <tr key={idx} className="hover:bg-[#FAF6F2] transition-colors">
                    ...
                    <td className="py-3.5 px-4">
                      <p className="font-semibold text-[#1C1B1A]">{inv.customer}</p>
                    ...
                    <td className="py-3.5 px-4 text-right">
                      <button
                        ...
                        className="px-2.5 py-1 bg-white hover:bg-[#FAF0EC] border border-[#E8E5DF] hover:border-[#D87A61] text-[#1C1B1A] hover:text-[#C14E30] rounded-md font-medium text-xs inline-flex items-center gap-1 transition-colors cursor-pointer shadow-2xs"
                      >
      ...
      {selectedInvoiceOrder && (
        ...
        >
          <div
            ...
            className="bg-white p-6 sm:p-8 rounded-2xl max-w-2xl w-full border border-[#E8E5DF] shadow-2xl space-y-6 animate-modal-content max-h-[90vh] overflow-y-auto"
          ...
          >
            ...
            <div className="flex items-center justify-between pb-4 border-b border-[#E8E5DF]">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-heading font-extrabold text-base text-[#1C1B1A]">
              ...
              <div className="flex items-center gap-2 print:hidden">
                <button
                  type="button"
                  onClick={handlePrint}
                  className="px-3 py-1.5 bg-[#FAF9F5] hover:bg-[#F2EFE9] border border-[#E8E5DF] rounded-lg text-xs font-medium flex items-center gap-1.5 transition-colors cursor-pointer"
                >
            ...
            <div className="grid grid-cols-2 gap-4 text-xs">
              <div className="space-y-1">
                ...
                <p className="font-semibold text-[#1C1B1A]">{selectedInvoiceOrder.customer}</p>
              ...
              <div className="space-y-1 text-right">
                ...
                <p className="font-mono text-[#1C1B1A]">
            ...
            <div className="border border-[#E8E5DF] rounded-lg overflow-hidden">
              <table className="w-full text-left text-xs border-collapse">
                <thead className="bg-[#FAF9F5] border-b border-[#E8E5DF] text-[#8C8880] font-mono text-[10px] uppercase">
                  <tr>
                ...
                <tbody className="divide-y divide-[#F2EFE9]">
                  {(selectedInvoiceOrder.items || []).map((item, i) => (
                    <tr key={i}>
                      <td className="p-3 font-semibold text-[#1C1B1A]">
                        {item.productName}
                        {item.size && (
                      ...
                      <td className="p-3 text-right font-mono font-bold text-[#1C1B1A]">
            ...
            <div className="flex justify-end pt-2">
              <div className="w-56 space-y-1.5 text-xs">
                ...
                <div className="flex justify-between font-bold text-[#1C1B1A] pt-2 border-t border-[#E8E5DF] text-sm">
            ...
            <div className="p-3 bg-[#FAF9F5] border border-[#E8E5DF] rounded-lg text-center text-[11px] text-[#8C8880]">
