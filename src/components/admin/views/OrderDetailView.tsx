...
export const OrderDetailView: React.FC<OrderDetailViewProps> = ({ orderId }) => {
  ...
  if (isLoading) {
    return (
      <div className="p-8 space-y-4 bg-white border border-[#EAE6DF] rounded-xl my-6">
  ...
  if (!order) {
    return (
      <div className="p-8 text-center space-y-4 bg-white border border-[#EAE6DF] rounded-xl my-6">
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-6xl mx-auto">
      ...
      <div className="p-4 sm:p-6 bg-white border border-[#EAE6DF] rounded-xl shadow-[0_1px_2px_rgba(0,0,0,0.02)] flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-xl space-y-4 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
            <div className="flex items-center justify-between border-b border-[#F0ECE5] pb-3">
              <h3 className="font-heading text-sm font-bold text-[#1F1E1D]">
                Item &amp; Spesifikasi
              </h3>
          ...
          <div className="p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-xl space-y-3.5 shadow-[0_1px_2px_rgba(0,0,0,0.02)] text-xs">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="p-4 sm:p-5 bg-white border border-[#EAE6DF] rounded-xl space-y-3 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
            <h3 className="font-heading text-sm font-bold text-[#1F1E1D] border-b border-[#F0ECE5] pb-2.5">
      ...
      {isPreviewModalOpen && order.design && (
        ...
        >
          <div
            className="bg-white p-4 sm:p-6 rounded-xl max-w-3xl w-full border border-[#EAE6DF] shadow-2xl space-y-4 animate-modal-content"
