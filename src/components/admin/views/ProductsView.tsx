...
import { getStoredProducts, toggleProductStock, deleteStoredProduct } from '../../../utils/storage';
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-[#EAE6DF]">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() =>
              showFeedback('Fitur tambah produk baru belum tersedia di panel ini. Tambahkan langsung lewat Supabase Table Editor untuk saat ini.', 'error')
            }
