    ...
    <div className="space-y-6 animate-fade-in">
                    ...
                    <td className="py-3 px-4 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <button
                          ...
                          className="p-1.5 text-[#8C8880] hover:text-[#1F1E1D] hover:bg-[#F2EFE9] rounded-md transition-colors cursor-pointer"
      ...
      {isFormOpen && (
        <div className="fixed inset-0 z-50 bg-[#1C1B1A]/40 backdrop-blur-xs flex items-center justify-center p-4 animate-modal-backdrop">
          <div className="bg-white rounded-2xl max-w-lg w-full border border-[#EAE6DF] shadow-xl animate-modal-content max-h-[90vh] overflow-y-auto">
            <div className="p-5 sm:p-6 border-b border-[#EAE6DF] flex items-center justify-between">
              <h4 className="font-heading text-base font-bold text-[#1F1E1D]">
                {editingProduct ? `Edit Produk: ${editingProduct.name}` : 'Tambah Produk Baru'}
              </h4>
              <button
                onClick={() => setIsFormOpen(false)}
                className="p-1 text-[#8C8880] hover:text-[#1F1E1D] cursor-pointer"
                aria-label="Tutup"
              >
                <X className="w-4 h-4" />
              </button>
            ...
            <div className="p-5 sm:p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-[#FAF9F5] border border-[#E8E4DA] focus:border-[#D87A61] rounded-lg text-sm text-[#1F1E1D] focus:outline-hidden transition-colors"
                />
              ...
              <label className="flex items-center gap-2 text-xs text-[#42403B] cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 accent-[#1F1E1D]"
                />
            ...
            <div className="p-5 sm:p-6 pt-0 flex justify-end gap-2">
              ...
              <button
                ...
                className="px-3.5 py-1.5 bg-[#1F1E1D] hover:bg-[#33312E] disabled:opacity-60 text-white text-xs font-semibold rounded-lg cursor-pointer"
              >
      ...
      {productToDelete && (
        <div className="fixed inset-0 z-50 bg-[#1C1B1A]/40 backdrop-blur-xs flex items-center justify-center p-4 animate-modal-backdrop">
          <div className="bg-white p-6 rounded-2xl max-w-sm w-full border border-[#EAE6DF] shadow-xl space-y-4 animate-modal-content">
