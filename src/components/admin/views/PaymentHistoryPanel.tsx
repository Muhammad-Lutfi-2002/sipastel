      ...
      <div className="flex items-center justify-between">
        ...
        {canRecordPayment && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-[#1F1E1D] hover:bg-[#33312E] text-white text-[11px] font-semibold rounded-lg transition-colors cursor-pointer"
          >
