    ...
    <div className="bg-surface border border-line rounded-2xl p-5 space-y-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        <div className="p-3 bg-paper border border-line rounded-lg">
          <p className="text-[10px] font-mono uppercase text-muted mb-0.5">Total Tagihan</p>
        ...
        <div className="p-3 bg-sage/10 border border-sage/30 rounded-lg">
          <p className="text-[10px] font-mono uppercase text-sage mb-0.5">Total Dibayar</p>
          <p className="text-sm font-bold text-sage">{formatIDR(order.totalPaid)}</p>
        </div>
        <div className="p-3 bg-danger/10 border border-danger/30 rounded-lg">
          <p className="text-[10px] font-mono uppercase text-danger mb-0.5">Sisa Pembayaran</p>
          <p className="text-sm font-bold text-danger">{formatIDR(remaining)}</p>
        </div>
        <div className="p-3 bg-paper border border-line rounded-lg">
          <p className="text-[10px] font-mono uppercase text-muted mb-0.5">Persentase</p>
          <div className="flex items-center gap-2">
              ...
              <div className={`p-3 rounded-lg border ${p.status === 'VOID' ? 'bg-danger/10 border-danger/30 opacity-70' : 'bg-paper border-line'}`}>
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    {p.status === 'VOID' && (
                      <span className="flex items-center gap-1 text-[10px] font-bold text-danger uppercase">
                  ...
                  {canVoidPayment && p.status === 'VALID' && (
                    <button
                      ...
                      className="text-[10px] font-semibold text-danger hover:underline cursor-pointer"
                    >
                      Batalkan
                    </button>
                  )}
      ...
      {voidTarget && (
        ...
        >
          <div onClick={(e) => e.stopPropagation()} className="bg-surface rounded-2xl p-5 w-full max-w-md space-y-4 shadow-2xl">
