...
export const ProductionView: React.FC = () => {
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      {feedback && (
        <div className="p-3 bg-[#EFF6EF] text-[#2D5931] border border-[#CDE5CD] rounded-lg text-xs flex items-center justify-between animate-modal-content">
          <span>{feedback}</span>
      ...
      <div className="bg-white border border-[#EAE6DF] rounded-xl p-3.5 sm:p-4 shadow-[0_1px_2px_rgba(0,0,0,0.02)] overflow-hidden">
          ...
          {displayedStages.map((stage, idx) => {
            ...
            return (
              <div
                key={stage.id}
                id={`lane-${stage.id}`}
                className="w-[330px] sm:w-[350px] min-w-[330px] sm:min-w-[350px] shrink-0 bg-[#FAF9F5] border border-[#EAE6DF] rounded-xl flex flex-col shadow-[0_1px_2px_rgba(0,0,0,0.02)] min-h-[520px] max-h-[720px]"
              >
                {/* Lane Sticky Header */}
