...
import { Lock, Mail, Eye, EyeOff, ArrowRight, ShieldCheck, AlertCircle, CheckCircle2, ArrowLeft, Sparkles } from 'lucide-react';
      ...
      <div className="w-full border-b border-[#E8E5DF] bg-[#FAF9F5] py-3 px-4 sm:px-8 flex items-center justify-between text-xs">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-[#8C8880] uppercase tracking-wider">Area Kerja Atelier</span>
          </div>
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-[#1C1B1A] text-[#FAF9F5] p-12 lg:p-16 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-4 text-sm text-[#A8A49C] max-w-md leading-relaxed">
              Pusat kendali operasional pakaian ready-to-wear dan pipeline produksi custom jersey Studio SIPASTEL Bandung.
            </p>
          </div>
          ...
          <div className="relative z-10 space-y-6 pt-12 border-t border-[#2D2B28]">
            <div className="grid grid-cols-2 gap-6 text-xs">
              <div>
                ...
                <p className="font-medium text-[#FAF9F5] mt-0.5">Bandung, Jawa Barat</p>
              </div>
              <div>
