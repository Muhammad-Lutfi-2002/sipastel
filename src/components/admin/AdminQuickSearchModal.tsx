...
export const AdminQuickSearchModal: React.FC<AdminQuickSearchModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#1C1B1A]/40 backdrop-blur-xs flex items-start justify-center pt-16 sm:pt-24 px-4">
      <div
        className="w-full max-w-2xl bg-[#FAF9F5] border border-[#E2DDD3] rounded-xl shadow-2xl overflow-hidden animate-modal-content flex flex-col max-h-[80vh]"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Search Input Bar */}
        <div className="p-3.5 sm:p-4 border-b border-[#E8E4DA] bg-white flex items-center gap-3">
          ...
          {!trimmed ? (
            <div className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  <button
                    ...
                    className="p-2.5 bg-white border border-[#E8E4DA] hover:border-[#D87A61] rounded-lg text-left transition-colors flex items-center justify-between"
                  >
              ...
              <div>
                ...
                <div className="divide-y divide-[#EFECE5] bg-white border border-[#E8E4DA] rounded-lg overflow-hidden">
                  {orders.slice(0, 4).map((o) => (
                    <div
                      ...
                      className="p-3 hover:bg-[#FAF6F2] transition-colors flex items-center justify-between cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#1F1E1D]"
                    >
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <img
                            src={p.images[0]}
                            alt={p.name}
                            className="w-8 h-8 rounded object-cover border border-[#E8E4DA]"
        ...
        {/* Footer info */}
        <div className="px-4 py-2.5 bg-[#F4F1EA] border-t border-[#E8E4DA] flex items-center justify-between text-[11px] text-[#8C8880]">
