...
export const AdminNotificationCenter: React.FC = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Popover Dropdown */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white border border-[#E8E4DA] shadow-[0_12px_40px_rgba(28,27,26,0.14)] rounded-2xl z-50 overflow-hidden animate-modal-content">
          {/* Header */}
