  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-[16px] px-1 rounded-full bg-[#C14E30] ring-2 ring-[#FAF9F5] text-[9px] font-bold text-white flex items-center justify-center">
      ...
      {/* Popover Dropdown */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white border border-[#E8E5DF] shadow-[0_12px_40px_rgba(28,27,26,0.14)] rounded-2xl z-50 overflow-hidden animate-modal-content">
          {/* Header */}
              ...
              displayedList.map((notif) => {
                ...
                return (
                  <div
                    ...
                    className={`w-full p-3.5 text-left transition-colors cursor-pointer flex items-start gap-3 hover:bg-[#FAF6F2] focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#1C1B1A] ${
