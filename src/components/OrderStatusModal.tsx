        ...
        {searchedOrder && (
          <div className="space-y-6 animate-fade-in">
            ...
            {searchedOrder.totalPrice > 0 && searchedOrder.remainingBalance > 0 && (
              <div className="p-4 bg-[#F5F2EA] rounded-[2px] border border-[#E8E5DF] space-y-3">
                <div className="flex items-center gap-2">
                  <Wallet className="w-4 h-4 text-[#677663]" />
                ...
                <div>
                  <p className="text-[11px] text-[#66645E] mb-2">
                      ...
                      <button
                        ...
                        className={`py-2 rounded-[2px] text-[11px] font-bold border cursor-pointer transition-colors ${
                          selectedPercentage === pct
                            ...
                            : 'bg-white border-[#DCD8D0] text-[#1C1B1A] hover:border-[#1C1B1A]'
                        }`}
                      >
                        {pct}%
                      </button>
                  ...
                  <div className="mt-2 p-2.5 bg-white border border-[#E8E5DF] rounded-[2px] flex items-center justify-between">
                    <span className="text-[11px] text-[#66645E]">Nominal yang perlu ditransfer:</span>
                    <span className="text-sm font-bold text-[#1C1B1A] font-mono">
                ...
                {studioProfile?.bankAccountNumber && (
                  <div className="p-2.5 bg-white border border-[#E8E5DF] rounded-[2px] flex items-center justify-between gap-2">
                    <div>
                      <p className="text-[10px] uppercase tracking-widest text-[#75726B]">
                        Transfer ke {studioProfile.bankName}
                      </p>
                      <p className="text-sm font-bold font-mono text-[#1C1B1A]">
                        {studioProfile.bankAccountNumber}
                      </p>
                      <p className="text-[11px] text-[#66645E]">a.n. {studioProfile.bankAccountHolder}</p>
                    </div>
                    <button
                      type="button"
                      onClick={() => {
                      ...
                      className="p-2 text-[#66645E] hover:text-[#1C1B1A] cursor-pointer shrink-0"
                      aria-label="Salin nomor rekening"
                      title="Salin nomor rekening"
                    >
                      {isAccountCopied ? (
                        <Check className="w-4 h-4 text-[#5B7C59]" />
                      ) : (
