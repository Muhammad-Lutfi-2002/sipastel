...
export const CustomOrderForm: React.FC<CustomOrderFormProps> = ({
  ...
  const processFile = (file: File) => {
    ...
    if (file.size > 25 * 1024 * 1024) {
      setErrors((prev) => ({
        ...prev,
        designFile: 'Ukuran file maksimal 25MB.',
      }));
      return;
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newOrder: Order = {
      ...
      design: formData.designFile ? formData.designFile.name : 'Design description provided',
          ...
          {currentStep === 4 && (
            <div className="space-y-5 animate-fade-in">
              <div className="border-b border-[#EAE7E1] pb-3 mb-5">
                ...
                <p className="text-xs text-[#75726B] mt-0.5">
                  Upload file desain atau logo Anda. Format didukung: PNG, JPG, PDF (Maks. 25MB).
                </p>
              </div>
          ...
          {currentStep === 7 && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="p-4 bg-[#FAF9F5] border border-[#E8E5DF] text-xs text-[#66645E] space-y-1">
                ...
                <p>3. Anda dapat langsung menghubungkan chat dengan WhatsApp admin untuk koordinasi cepat.</p>
              </div>
            </div>
          )}
