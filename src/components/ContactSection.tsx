        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="space-y-3 pt-2 text-xs sm:text-sm text-[#42403B]">
            ...
            <div className="flex items-start gap-3.5 p-4 bg-[#FAF9F5] border border-[#E8E5DF] rounded-[2px]">
              ...
              <div>
                <span className="font-bold text-[#1C1B1A] block">Production Workshop & Atelier</span>
                <span className="text-xs text-[#75726B]">Kota Bandung, Jawa Barat, Indonesia</span>
              </div>
            </div>
          </div>
        </div>
