  ...
  return (
    <div className="min-h-screen bg-[#FAF9F5] text-[#1C1B1A] flex flex-col font-sans selection:bg-[#EAE5D9] selection:text-[#1C1B1A]">
      ...
      <main className="flex-1">
        {/* VIEW: HOME & SHOP (Hidden - redirects to Atelier Production Board) */}
        {(currentView === 'home' || currentView === 'shop') && (
          <div className="max-w-xl mx-auto px-4 py-20 text-center animate-fade-in">
            <div className="p-8 bg-white border border-[#EAE6DF] rounded-xl shadow-xs space-y-4">
              ...
              <div>
                <h2 className="font-heading text-lg font-bold text-[#1F1E1D]">SIPASTEL Atelier Production</h2>
              ...
              <button
                ...
                className="px-4 py-2 bg-[#1F1E1D] text-white text-xs font-semibold rounded-lg cursor-pointer hover:bg-black transition-colors"
              >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12">
            ...
            <div className="mb-6">
              <button
                type="button"
                onClick={() => navigate('/admin/production')}
                className="inline-flex items-center gap-2 text-xs font-semibold text-[#5E5B54] hover:text-[#1F1E1D] bg-white hover:bg-[#FAF9F5] border border-[#E8E4DA] px-3.5 py-1.5 rounded-lg shadow-2xs transition-colors cursor-pointer"
              >
